...
moss-network 폴더 생성 후, fabric, fabric-ca linux 바이너리를 다운받아서 압축을 풉니다.
...
* ./moss-network/organizations/fabric-ca/orderer1/fabric-ca-server-config.yaml
* ./moss-network/organizations/fabric-ca/platform/fabric-ca-server-config.yaml
* ./moss-network/organizations/fabric-ca/customer/fabric-ca-server-config.yaml
* ./moss-network/organizations/fabric-ca/service1/fabric-ca-server-config.yaml
* ./moss-network/organizations/fabric-ca/service2/fabric-ca-server-config.yaml
