...
. 채널명 환경변수 설정 : CHANNEL_NAME="service1"
...
* peers.{peer}.tlsCACerts.pem : tlsca/tlsca.{organization}.moss.com-cert.pem
* certificateAuthorities.{ca}.tlsCACerts:pem: ca/ca.{organization}.moss.com-cert.pem
...
└── organizations
    ...
    └── peerOrganizations
        ├── customer.moss.com
        │    ...
        │   └── connection-customer.yaml
        ├── platform.moss.com
        │    ...
        │   └── connection-platform.yaml
        ├── service1.moss.com
        │    ...
        │   └── connection-service1.yaml
        └── service2.moss.com
             ...
             └── connection-service2.yaml
```
